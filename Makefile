...
udp: $(BUILD_DIR)/udp/daemon $(BUILD_DIR)/udp/server $(BUILD_DIR)/udp/client
...
$(BUILD_DIR)/udp/daemon: $(UDP_DIR)/daemon.c | $(BUILD_DIR)/udp
	$(CC) $(CFLAGS) $(UDP_DIR)/daemon.c $(UDP_DIR)/checksum.c -o $(BUILD_DIR)/udp/daemon -I $(SRC_DIR) -I $(UDP_DIR)
